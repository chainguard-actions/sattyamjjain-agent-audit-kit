...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 320 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 320 rules across 94 scanner modules
