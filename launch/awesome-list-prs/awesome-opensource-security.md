...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 319 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 319 rules across 94 scanner modules
