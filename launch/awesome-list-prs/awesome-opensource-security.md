...
```markdown
- [AgentAuditKit](https://github.com/sattyamjjain/agent-audit-kit) - Security scanner for MCP-connected AI agent pipelines with 273 rules, OWASP MCP/Agentic Top 10 mapping, and SARIF output
```
...
- 273 rules across 86 scanner modules
