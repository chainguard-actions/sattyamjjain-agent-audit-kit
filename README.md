...
<p align="center">
  ...
  <a href="#what-it-scans"><img src="https://img.shields.io/badge/rules-205-blue.svg" alt="Rules: 205"></a>
...
- **<!-- rule-count:total -->205<!-- /rule-count --> rules** across 11 security categories, covering the 2026 CVE wave
- **<!-- scanner-count:total -->65<!-- /scanner-count --> scanner modules** including AST-based Python taint analysis and regex pattern scanners for TypeScript/JavaScript and Rust
...
| Detection rules (static) | **<!-- rule-count:total -->205<!-- /rule-count -->** | Runtime policies, not rules | ~30 | LLM-assisted |
