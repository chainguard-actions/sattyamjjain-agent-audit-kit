...
jobs:
  scan:
    ...
    steps:
      ...
      - uses: sattyamjjain/agent-audit-kit@v0.6.1
        id: scan
        with:
          fail-on: high
...
cd agent-audit-kit
pip install -e ".[dev]"
pytest -v                          # <!-- test-count:total -->2,347<!-- /test-count --> test functions
ruff check .                       # Lint
